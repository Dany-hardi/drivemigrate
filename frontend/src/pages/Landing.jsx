      ...
      <nav className="relative z-10 flex items-center justify-between px-6 sm:px-10 py-5 border-b border-[#1a1a1a]">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => navigate('/admin')}
            className="text-[#333330] text-xs hover:text-[#f5c518] transition-colors font-['JetBrains_Mono'] border border-[#1a1a1a] hover:border-[#f5c518]/20 rounded-lg px-3 py-1.5">
            Admin
          </button>
        </div>
      </nav>
